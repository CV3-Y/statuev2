  ...
  const svg = await satori(
    ...
    >
      ...
      */}
      ...
      {/* [Loc] 위치 */}
      <div style={{ position: 'absolute', top: 225, left: 1232, fontSize: 60, fontWeight: 600 }}>Loc</div>
      <div style={{ 
      ...
      {/* [Class] 직업 */}
      <div style={{ position: 'absolute', top: 225, left: 1797, fontSize: 60, fontWeight: 600 }}>Class</div>
      <div style={{ 
